...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2023 at 07:09 PM
...
(1202, 'Hayley Atwell'),
(1203, 'Ving Rhames'),
(1301, 'Leonardo DiCaprio'),
(1302, 'Kate Winslet'),
(1303, 'Billy Zane'),
(1401, 'Reza Rahadian'),
(1402, 'Bunga Citra Lestari'),
(1403, 'Tio Pakusadewo'),
(1501, 'Amanda Rawles'),
(1502, 'Jefri Nichol'),
(1503, 'Surya Saputra'),
(1601, 'Reza Rahadian '),
(1602, 'Michelle Ziudith '),
(1603, 'Anya Geraldine '),
(1701, 'Alec Baldwin'),
(1702, 'Steve Buscemi'),
(1703, 'Jimmy Kimmel'),
(1801, 'Aliando Syarief'),
(1802, 'Adipati Dolken'),
(1803, 'Randy Danistha'),
(1901, 'Bunga Citra Lestari'),
(1902, 'Reza Rahadian'),
(1903, 'Alex Abbad'),
...
(2502, 'Byeon Woo-seok'),
(2503, 'Park Jung-woo'),
(2601, 'Anna-Maria Sieklucka'),
(2602, 'Michele Morrone'),
(2603, 'Bronislaw'),
(2701, 'Denzel Washington'),
(2702, 'Marton Csokas'),
(2703, 'Chloë Grace'),
(2801, 'Denzel Washington'),
(2802, 'Pedro Pascal'),
(2803, 'Ashton Sanders'),
(2901, 'Robin Williams'),
(2902, 'Kirsten Dunst'),
(2903, 'David Alan Grier'),
(3001, 'Dwayne Johnson'),
(3002, 'Alex Wolff'),
(3003, 'Kevin Hart'),
(3201, 'Chris Pine'),
(3202, 'Michelle Rodriguez'),
(3203, 'Regé-Jean Page');
...
--
ALTER TABLE `film_cast`
  ADD CONSTRAINT `film_cast_ibfk_1` FOREIGN KEY (`CastID`) REFERENCES `list_cast` (`CastID`),
  ADD CONSTRAINT `film_cast_ibfk_2` FOREIGN KEY (`FilmID`) REFERENCES `film` (`FilmID`);
COMMIT;
