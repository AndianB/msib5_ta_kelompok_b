...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Des 2023 pada 11.16
...
(1, 'joko', 'joko@gmail.com', 'avatar film', 'keren sekali trailernya aku sangat tidak sabar'),
(6, 'hasan', 'hasan@gmail.com', 'web', 'menurutku web ini sangat keren');
...
--
ALTER TABLE `kontak`
  MODIFY `KontakID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
