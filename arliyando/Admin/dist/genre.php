                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td> <a href="proses_hapusgenre.php?isbn=<?php echo $data["GenreID"] ?>" class="label label-danger"> Delete </a> &nbsp; <a href="editgenre.php?isbn=<?php echo $data["GenreID"] ?>" class="label label-warning"> Ubah </a></td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } ?>
                                        </tbody>
