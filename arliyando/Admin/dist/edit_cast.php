        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    $cast = mysqli_query($conn, "SELECT * from list_cast where CastID='$_GET[CastID]'");

                    while ($l = mysqli_fetch_array($cast)) {
                        $CastID = $l["CastID"];
                                ...
                                <div class="col">
                                    <form action="proses_update_data_list_cast.php?CastID=<?php echo $_GET['CastID'] ?>" method="post" enctype="multipart/form-data">
                                        <div class=" mb-3">
                                            ...
                                            <input type="text" name="CastID" class="form-control" id="exampleFormControlInput1" placeholder="Cast ID" value="<?php echo $CastID ?>">
                                        </div>
                                        <div class=" mb-3">
