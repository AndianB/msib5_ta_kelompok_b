...
<body>
  ...
  <main>
    <!-- breadcrumb-area -->
    <section class="breadcrumb-area breadcrumb-bg" data-background="img/bg/bg_about4.jpg">
      <div class="container">
        <div class="row">
          <div class="col-12">
                ...
                <div class="rc-post">
                  <ul>
                    <li class="rc-post-item">
                      <div class="thumb">
                        <a href="blog-details.php"><img src="img/blog/rc_post_thumb01.jpg" alt="" /></a>
                      </div>
                      <div class="content">
                        <h5 class="title">
                          <a href="blog-details.php">Express Management Effective</a>
                        </h5>
                        <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                      </div>
                    </li>
                    <li class="rc-post-item">
                      <div class="thumb">
                        <a href="blog-details.php"><img src="img/blog/rc_post_thumb02.jpg" alt="" /></a>
                      </div>
                      <div class="content">
                        <h5 class="title">
                          <a href="blog-details.php">Where watch English movies free?</a>
                        </h5>
                        <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                      </div>
                    </li>
                    <li class="rc-post-item">
                      <div class="thumb">
                        <a href="blog-details.php"><img src="img/blog/rc_post_thumb03.jpg" alt="" /></a>
                      </div>
                      <div class="content">
                        <h5 class="title">
                          <a href="blog-details.php">House movie streaming website</a>
                        </h5>
                        <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                      </div>
                    </li>
